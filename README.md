...
The website is of intuitive design, and is hopefully easy to understand. The project is using Visual Studio as an IDE. With this project is also attached the reports that was made in conjunction. An openAPI have also been made for this project, that can be found here: https://app.swaggerhub.com/apis/kris701/P2Project/1.0.0-oas3#/
